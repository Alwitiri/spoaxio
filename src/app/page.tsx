  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#060606] text-white overflow-x-hidden">
        {/* ============ NAVBAR ============ */}
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#060606]/80 backdrop-blur-xl border-b border-white/[0.06]" : ""}`}>
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link href="/home" className="hidden sm:block text-sm text-white/50 hover:text-white transition-colors">Sign In</Link>
        ...
        <motion.section ref={heroRef} style={{ opacity: heroOpacity, scale: heroScale }} className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.25 }} className="text-base sm:text-lg text-white/35 max-w-xl mx-auto mb-10 leading-relaxed">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.35 }} className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link href="/explore" className="w-full sm:w-auto px-8 py-3.5 bg-white/[0.04] border border-white/[0.08] text-white/60 font-medium rounded-xl hover:bg-white/[0.08] transition-all text-[15px]">
                  Explore Games
                </Link>
              </motion.div>
            </div>
        ...
        {/* ============ SPORTS MARQUEE ============ */}
        <div id="sports" className="py-8 border-y border-white/[0.04] overflow-hidden">
          <div className="marquee flex items-center gap-12 whitespace-nowrap">
            {[...sports, ...sports].map((s, i) => (
              <div key={i} className="flex items-center gap-3 text-white/15">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <Section>
              <div className="text-center mb-16">
                ...
                <p className="text-white/30 mt-3 max-w-lg mx-auto text-sm">Get you from &quot;I want to play&quot; to actually playing — in under 60 seconds.</p>
              </div>
            </Section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {features.map((f, i) => (
                <Section key={f.title} delay={i * 0.08}>
                  <div className="group p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-300 h-full">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-4" style={{ backgroundColor: `${f.color}0A` }}>
                      {f.emoji}
                    </div>
                    <h3 className="text-base font-semibold text-white mb-2 group-hover:text-primary/90 transition-colors">{f.title}</h3>
              ...
              <div className="relative bg-gradient-to-br from-primary/[0.06] to-cyan-500/[0.04] border border-primary/10 rounded-3xl p-8 md:p-14 overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Link href="/games" className="px-6 py-3 bg-white/[0.06] border border-white/[0.1] rounded-xl text-sm text-white/60 hover:bg-white/[0.1] transition-all">
                      Browse Games
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {testimonials.map((t, i) => (
                <Section key={t.name} delay={i * 0.1}>
                  <div className="p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl h-full flex flex-col">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <Section>
              <div className="text-center">
                ...
                <p className="text-white/30 max-w-md mx-auto mb-8 text-sm">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
              <div>
                ...
                <p className="text-xs text-white/20 leading-relaxed">The local sports network for players who want to play more.</p>
              </div>
              <div>
                <p className="text-[10px] text-white/20 uppercase tracking-wider font-medium mb-3">Product</p>
                <div className="space-y-2">
                  <Link href="/games" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Games</Link>
                  <Link href="/turfs" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Turfs</Link>
                  <Link href="/players" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Players</Link>
                  <Link href="/gyms" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Gyms</Link>
                </div>
              </div>
              <div>
                <p className="text-[10px] text-white/20 uppercase tracking-wider font-medium mb-3">Company</p>
                <div className="space-y-2">
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">About</a>
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Blog</a>
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Careers</a>
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Contact</a>
                </div>
              </div>
              <div>
                <p className="text-[10px] text-white/20 uppercase tracking-wider font-medium mb-3">Legal</p>
                <div className="space-y-2">
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Privacy Policy</a>
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Terms of Service</a>
                  <a href="#" className="block text-xs text-white/30 hover:text-white/60 transition-colors">Cookie Policy</a>
                </div>
              </div>
            </div>
            <div className="pt-6 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-3">
              <p className="text-[11px] text-white/15">&copy; 2026 Spoaxio. All rights reserved.</p>
