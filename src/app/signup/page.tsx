    ...
    <>
      ...
      <form onSubmit={handleSignup} className="space-y-3.5">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full h-[50px] bg-primary hover:brightness-110 text-black font-semibold text-[15px] rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-1"
        >
          {loading ? (
      ...
      <div className="fixed inset-0 bg-[#060606] overflow-hidden">
        ...
        <div className="flex lg:hidden flex-col h-full relative">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-[30%] left-0 right-0 h-px overflow-hidden">
