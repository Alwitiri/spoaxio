  ...
  return (
    <div className="fixed inset-0 bg-white flex flex-col">
      ...
      <div className="px-5 pt-5 pb-3 shrink-0">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold text-gray-900">Find Gyms</h1>
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full h-[44px] pl-10 pr-4 bg-gray-50 rounded-xl text-gray-900 text-sm placeholder:text-gray-400 outline-none border border-gray-200 focus:border-orange-500/40 transition-all"
          />
        </div>
      ...
      <div className="px-5 py-2 flex items-center justify-between shrink-0">
        <p className="text-xs text-gray-500">{sorted.length} gyms found</p>
          ...
          {sorted.map((gym) => (
            ...
            >
              ...
              <div className="h-36 bg-gradient-to-br from-white/[0.04] to-white/[0.02] relative overflow-hidden">
                ...
                <div className="absolute top-3 right-3 flex items-center gap-2">
                  ...
                  <div className="px-2 py-1 bg-black/50 backdrop-blur-sm rounded-lg flex items-center gap-1">
                    ...
                    <span className="text-[11px] font-medium text-gray-900">{gym.rating}</span>
                  </div>
                </div>
              ...
              <div className="px-4 pb-4 -mt-2 relative">
                <h3 className="text-[15px] font-semibold text-gray-900 mb-1 group-hover:text-orange-400/90 transition-colors">{gym.name}</h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="text-base font-bold text-gray-900">₹{gym.price.toLocaleString()}</span>
                    <span className="text-xs text-gray-500 ml-0.5">/{gym.priceUnit}</span>
                  </div>
                </div>
              </div>
            </Link>
